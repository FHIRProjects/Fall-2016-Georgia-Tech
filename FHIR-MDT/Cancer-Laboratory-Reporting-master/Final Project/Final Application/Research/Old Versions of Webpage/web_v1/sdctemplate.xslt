...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0" xmlns:sr="http://www.cap.org/pert/2009/01/" xmlns:x="http://healthIT.gov/sdc">
      ...
      <html>
         <head>
          <myField>
            ...
            <script type="text/javascript" src="sdc.js"/>
            ...
            <table class="HeaderGroup" align="center">
               ...
               <tr>
                  <td>
                     ...
                     <xsl:choose>
                        <xsl:when test="$required = 'false'"> </xsl:when>
                        <xsl:otherwise>
